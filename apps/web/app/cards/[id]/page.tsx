...
import { useCreditCards, useRewardRules, useTagMappings } from '@/hooks/useLocalStorage';
        ...
        <TabsContent value="transactions" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and categorize your card transactions</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12 text-muted-foreground">
                <Calendar className="h-12 w-12 mx-auto mb-4" />
                <p className="text-lg mb-2">Transaction View Coming Soon</p>
                <p>Connect to YNAB to see your transactions</p>
                <Button variant="outline" className="mt-4" asChild>
                  <Link href="/settings">
                    Configure YNAB Connection
                  </Link>
                </Button>
              </div>
            </CardContent>
